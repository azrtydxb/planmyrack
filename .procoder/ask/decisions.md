...
- **Decided (2026-08-31): Apple Developer Program + EAS internal distribution.** Register
  the iPad with `eas device:create`, build `--profile device`, install from the link EAS
  returns. Over the air, no cable, the build keeps working.
