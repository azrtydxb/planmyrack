...
export const BUNDLED_CATALOG: CatalogEntry[] = [
  ...
  entry('unifi-usw-24', 'UniFi', 'Switch 24', 'switch', 1, 24, 0, 0, COLOURS[0]!, STRUCTURAL, {
    faceplate: 'sfp',
    sfp: 2,
  }),
  entry(
  ...
  entry('unifi-usw-48', 'UniFi', 'Switch 48', 'switch', 1, 48, 0, 0, COLOURS[0]!, STRUCTURAL, {
    faceplate: 'sfp',
    sfp: 4,
  }),
  entry(
